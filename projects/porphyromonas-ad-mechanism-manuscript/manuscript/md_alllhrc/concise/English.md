...
Candidate micropeptides can occupy the AChE PAS after hypothesized blood–brain barrier leakage in periodontitis. Best-pose docking and 100-ns residence at that surface provide a structural hypothesis for gorge occlusion (cholinergic deficit) and for PAS-centered pathological chaperone activity toward Aβ, following Atanasova et al., Inestrosa et al., Silman and Sussman, and the *P. gingivalis* brain findings of Dominy et al. These remain computational hypotheses. Each system is a single 100-ns trajectory; planned checks include isothermal titration calorimetry, surface plasmon resonance, and Ellman inhibition.
