...
This study therefore comprises two sequential computational stages. An oral-smORF cascade is first reconstructed to show how twelve 7–9-aa sequences were prioritized. Those twelve peptides are then docked into human AChE, and three representative complexes are simulated for 100 ns against an apo control. The work is interpreted as a computational analogy of periodontal micropeptides onto the AChE–Aβ PAS pathway.
...
### Interpretation of docking and MD observations

**Table 5. Supported and unsupported interpretations of docking and 100-ns MD observations.**
...
The screening cascade reduces a multimillion-candidate smORF space to a tractable twelve-sequence set, and docking plus 100-ns MD place those peptides on human AChE. FLLHTTR and YLSLLQR complexes are more compact than apo in late RMSD; FLLHTTR holds the densest hydrogen-bond network (7.03 ± 1.28); YLSLLQR is the only complex with SASA burial and the most rigid peptide (self-fit RMSD 0.0911 nm). These results do not validate a periodontal–AD mechanism. They define a bounded computational chain: an operational candidate list, residue-level PAS poses, and three folded complexes that remain surface-bound over 100 ns, with peptide-specific interfacial modes.
...
2. A stable complex: the enzyme does not unfold and the peptide does not leave.  
   Figures 4–6 show globular AChE over 100 ns: RMSD 0.16–0.19 nm, Rg 2.30–2.31 nm, and α-helix ~33% / β-sheet ~17% overlaying apo. ALLLHRC closely follows the apo trajectory. FLLHTTR and YLSLLQR fall below apo in late RMSD (Figures 5A, 6A), indicating that binding rigidifies rather than strains the scaffold. Last-20-ns hydrogen bonds persist, with peptide-specific occupancy (ALLLHRC 2.19 ± 0.80 after early decay, FLLHTTR 7.03 ± 1.28 throughout, YLSLLQR 2.93 ± 1.14) and seven contact pairs. This matches Lushchekina and Atanasova on a stable, surface-bound complex.
