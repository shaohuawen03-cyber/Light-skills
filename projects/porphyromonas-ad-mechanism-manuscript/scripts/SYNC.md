...
```bash
python3 scripts/manage_version_tag.py create --version 3.7.0 --message "v3.7.0: journal-aligned manuscripts with expanded concise variants and ongoing MD integration" --push
