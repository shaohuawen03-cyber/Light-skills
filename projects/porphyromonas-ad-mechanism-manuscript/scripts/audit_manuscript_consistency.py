...
EXPECTED = [
    ...
    "6.98", "97.95", "93.77", "6.23", "27.98", "13.51", "10.81", "7.21", "66.67",
    "FLLHTTR", "HVLLLRQCA", "−9.60", "−8.25", "0.04", "0.12",
]
REFERENCE_COUNT = 53
...
def audit(path: Path, lang: str):
    ...
    return {
        ...
        "reference_sequence_ok": reference_numbers == list(range(1, REFERENCE_COUNT + 1)),
    }
...
def main() -> int:
    ...
    checks = {
        ...
        "references_1_to_53_bilingual": en["reference_sequence_ok"] and zh["reference_sequence_ok"],
    }
